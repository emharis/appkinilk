...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-body">
            <a class="btn btn-primary btn-sm" id="btn-add" href="master/user/create" >Create</a>
            ...
            <table class="table table-bordered table-condensed table-striped table-hover" id="table-data" >
                <thead>
                    <tr>
                        ...
                        <th class="col-sm-2 col-md-2 col-lg-2" >Username</th>
                        <th>Role</th>
                ...
                <tbody>
                  ...
                  @foreach ($data as $dt)
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-success btn-xs" href="master/user/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
...
(function ($) {
    ...
    $(document).on('click','.row-to-edit',function(){
        ...
        location.href = 'master/user/edit/' + data_id ;
    });
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','master/user/delete');
