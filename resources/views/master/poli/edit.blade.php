...
<section class="content">
  {{-- <form method="POST" action="master/poli/insert" > --}}
    <div class="box box-solid" >
      <div class="box-body" >
        <form method="POST" action="master/poli/update" >
          <input type="hidden" name="poli_id" value="{{$data->id}}"/>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger" href="master/poli" >Cancel</a>
                    </td>
                </tr>
            </tbody>
        </table>
