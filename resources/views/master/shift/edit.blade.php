...
<section class="content">
  {{-- <form method="POST" action="master/shift/insert" > --}}
    <div class="box box-solid" >
      <div class="box-body" >
        <form method="POST" action="master/shift/update" >
          ...
          <table class="table table-bordered table-condensed" >
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="masuk" class="form-control" value="{{$data->masuk}}" required/>
                    </td>
                </tr>
                <tr>
                    <td class="col-lg-2 col-md-2 col-sm-2" >
                    ...
                    <td>
                        <input type="text" name="pulang" class="form-control" value="{{$data->pulang}}" required/>
                    </td>
                </tr>
                <tr>
                    <td></td>
