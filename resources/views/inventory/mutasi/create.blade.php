  ...
  {{-- <form method="POST" action="inventory/mutasi/insert" > --}}
    <div class="box box-solid" >
      <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
          <label><h3 style="margin:0;padding:0;font-weight:bold;" >Create Mutasi</h3></label>
          ...
          <table class="table table-condensed" >
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" name="tanggal" class="input-tanggal form-control" value="{{date('d-m-Y')}}" required autocomplete="off" >
                    </td>
                    <td>
                      <label>Paraf</label>
                    </td>
    ...
    <div class="box-footer" >
      ...
      <a class="btn btn-danger" href="inventory/mutasi" >Cancel</a>
    </div>
  {{-- </form> --}}
</section><!-- /.content -->
