...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-body">
            <a class="btn btn-primary btn-sm" id="btn-add" href="inventory/obat/create" >Create</a>
                ...
                <tbody>
                  ...
                  @foreach ($data as $dt)
                    <tr>
                      ...
                      <td class="text-right" >
                        {{$dt->current_stok > 0 ? $dt->current_stok : 0}}
                      </td>
                      <td class="text-center" >
                        <a class="btn btn-success btn-xs" href="inventory/obat/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
...
(function ($) {
    ...
    $(document).on('click','.row-to-edit',function(){
        ...
        location.href = 'inventory/obat/edit/' + data_id ;
    });
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','inventory/obat/delete');
